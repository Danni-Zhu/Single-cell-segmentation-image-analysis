...
def process_image(mask_path, tiff_path, output_base):
    try:
        ...
        # Channel mapping for your specific needs (channels 0, 1, and 3)
        channel_mapping = {0: 'CD45_1', 1: 'G6', 3: 'CD45_2'}

        # Process channels 0, 1, and 3
        for i, name in channel_mapping.items():
            channel_image = tiff_image[..., i]

            # Measure properties using regionprops_table
            properties = regionprops_table(mask, intensity_image=channel_image,
